...
class AdminController extends Controller
{
    ...
    */
    public function dashboard()
    {
        ...
        $data['earnings'] = Earning::sum('amount') + EarningResdex::sum('amount');
        ...
        $latest_earnings = Earning::with('plan', 'manualPayment:id,name')->latest()->take(5)->get();
        $latest_earnings_resdex = EarningResdex::with('plan', 'manualPayment:id,name')->latest()->take(5)->get();
        ...
        return view('backend.index', compact('data', 'earnings', 'popular_countries', 'latest_jobs', 'latest_earnings', 'users', 'current_currency','latest_earnings_resdex'));
    }
    ...
    */
    public function viewTransactionInvoiceResdex(EarningResdex $transaction)
    {
        ...
        return view('frontend.pages.invoice.preview-invoice-resdex', compact('transaction'));
    }
