...
class Company extends Model implements HasMedia
{
    ...
    // added
        public function userPlanResdex(): HasOne
    {
        return $this->hasOne(UserPlanResdex::class, 'company_id');
    }
    
    public function bookmarkCandidatesResdex()
    {
        return $this->belongsToMany(Candidate::class, 'bookmark_company_resdex')->with('user')->withPivot('category_id')->withTimestamps();
    }
}
