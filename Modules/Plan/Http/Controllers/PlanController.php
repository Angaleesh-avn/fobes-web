...
class PlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $descriptions = $request->except(['_token', 'label','strikethrough_price','plan_valid_days', 'price', 'job_limit', 'featured_job_limit', 'highlight_job_limit', 'frontend_show', 'candidate_cv_view_limitation', 'candidate_cv_view_limit', 'profile_verify']);
    ...
    public function update(Request $request, Plan $plan)
    {
        ...
        $descriptions = $request->except(['_token', '_method', 'label','strikethrough_price','plan_valid_days', 'price', 'job_limit', 'featured_job_limit', 'highlight_job_limit', 'frontend_show', 'candidate_cv_view_limitation', 'candidate_cv_view_limit', 'profile_verify']);
