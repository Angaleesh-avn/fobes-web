...
Route::post('payment/resdex', [RazorpayController::class, 'paymentresdex'])->name('razorpay.post.resdex');
...
Route::controller(ManualPaymentController::class)->group(function () {
    ...
    Route::post('/manual/payment_resdex', 'paymentPlaceResdex')->name('manual.payment_resdex');
    Route::get('/manual/payment/{order}/mark-paid-resdex', 'markPaidResdex')->name('manual.payment.mark.paid_resdex');
});
