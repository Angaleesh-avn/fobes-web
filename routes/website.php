...
Route::controller(WebsiteController::class)->name('website.')->group(function () {
    ...
    Route::get('/abroad-jobs', 'abroad_jobs')->name('abroad_jobs');
    ...
    Route::get('/plan_resdex/{label}', 'planResdexDetails')->name('plan_resdex.details');
    ...
    Route::get('/abroad_loadmore', 'abroad_loadmore');
    ...
    Route::get('/candidates/bulk_download_resume', 'bulkDownloadResume')->name('candidate.bulk_download_resume');    //added
    ...
    Route::get('/candidate/profile/details_resdex', 'candidateProfileDetailsResdex')->name('candidate.profile.details_resdex');
...
Route::middleware('auth:user', 'verified')->group(function () {
    ...
    Route::controller(CompanyController::class)->prefix('company')->middleware(['company', 'has_plan'])->name('company.')->group(function () {
        Route::middleware('company.profile')->group(function () {
            ...
            Route::get('view/transaction/invoice/resdex/{transaction:order_id}', 'viewTransactionInvoiceResdex')->name('transaction.invoice.view.resdex');
            Route::post('download/transaction/invoice/resdex/{transaction}', 'downloadTransactionInvoiceResdex')->name('transaction.invoice.download.resdex');
        });
        ...
        // added
        Route::get('resdex_plans', 'resdex_plans')->name('resdex_plans');
        Route::get('resdex_plans/candidates', 'resdex_plans_candidate')->name('resdex_plans.candidates');


        Route::get('resdex_plans/bookmarks', 'resdex_plans_bookmarks')->name('resdex_plans.bookmark');

        Route::post('/resdex_plans/company/bookmark/{candidate}', 'companyBookmarkCandidateResdex')->name('companybookmarkcandidate_resdex')->middleware('user_active');
        Route::get('/resdex_plans/bookmark/categories', 'bookmarkCategoriesResdex')->name('bookmark.category.index_resdex');
        Route::post('/resdex_plans/bookmark/categories/store', 'bookmarkCategoriesStoreResdex')->name('bookmark.category.store_resdex');
        Route::get('/resdex_plans/bookmark/categories/edit/{category}', 'bookmarkCategoriesEditResdex')->name('bookmark.category.edit_resdex');
        Route::put('/resdex_plans/bookmark/categories/update/{category}', 'bookmarkCategoriesUpdateResdex')->name('bookmark.category.update_resdex');
        Route::delete('/resdex_plans/bookmark/categories/destroy/{category}', 'bookmarkCategoriesDestroyResdex')->name('bookmark.category.destroy_resdex');
