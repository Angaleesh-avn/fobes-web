...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::controller(AdminController::class)->group(function () {
            ...
            Route::post('/admin/download/transaction/invoice_resdex/{transaction}', 'downloadTransactionInvoiceResdex')->name('admin.transaction.invoice.download_resdex');
            Route::post('/view/transaction/invoice_resdex/{transaction}', 'viewTransactionInvoiceResdex')->name('admin.transaction.invoice.view_resdex');
        });
        ...
        Route::controller(OrderController::class)->group(function () {
            ...
            Route::get('/orders_resdex', 'index_resdex')->name('order.index_resdex');
            Route::get('/order/create_resdex', 'create_resdex')->name('order.create_resdex');
            Route::post('/order/store_resdex', 'store_resdex')->name('order.store_resdex');
            Route::get('/orders_resdex/{id}', 'show_resdex')->name('order.show_resdex');
        });
