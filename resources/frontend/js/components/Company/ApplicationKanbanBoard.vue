<template>
    <div>
                ...
                <div class="height-100vh">
                    ...
                    <draggable class="list-group kanban-column scrollbar-hidden tw-px-5" v-model="applicationGroup.applications"
                        ...
                        <div class="application-card" v-for="application in applicationGroup.applications"
                            ...
                            <div class="appliaction-card-top" data-toggle="modal" @click.prevent="previewResume(application.candidate.user.username,application.answers,application.candidate_resume_id)">
        ...
        <CandidateResumeModal
            ...
            :answers="answers"
	    :resume="candidateResumeID"
            :show="showCandidateResumeModal"
            @close-modal="showCandidateResumeModal = false" v-if="showCandidateResumeModal" :language="languageTranslation"/>
...
axios({
            ...
            previewResume(username,answers,resumeID){
...
if (!response.success) {console.log(response)
                            if (response.redirect_url) {
                       		...
                       		this.candidateResumeID=resumeID;
                            this.showCandidateResumeModal = true;
                            this.candidateResumeInformation = response;
                        }
