...
<div class="download-cv-btn" v-if="resume"> <a @click="downloadCv(resume)" href="javascript:void(0)" class="btn-cv"> <span>{{ __('download_cv') }}</span> </a> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        <div class="row">
                                                ...
                                                <ul class="nav nav-tabs tw-gap-x-6 !tw-border-b !tw-border-[#E3E5E6]"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <button class="ll-nav-link nav-link active" id="home-tab"
                                                            ...
                                                            aria-selected="true">{{ __('cover_letter') }}</button>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                                        ...
                                                        <div
                                                            ...
                                                            <p class="tw-mb-0">{{ candidate.cover_letter.cover_letter }}</p>
                                                    ...
                                                    <div class="tab-pane fade " id="profile" role="tabpanel"
                                                        ...
                                                        <div class="tw-py-6">
                                                            <h4
                                                                ...
                                                                {{ __('biography') }}</h4>
                                                            <p class="tw-text-base tw-text-[#5E6670]" id="candidate-bio">{{
                                                                sanitizedBio }} </p>
                                                            <h4
                                            ...
                                            <div v-if="answers && answers.length">
                                                <h2 class="title mt-4 text-uppercase">{{ __('question ans answers') }}</h2>
                                    ...
                                    <div class="contact-icon-box">
                                        ...
                                        <div class="info">
                                            ...
                                            <h2 class="title" id="candidate_seconday_phone">
                                                {{ data . contact_info && data . contact_info . secondary_phone ? data .
