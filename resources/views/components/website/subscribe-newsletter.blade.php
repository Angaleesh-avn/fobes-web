                ...
                <div class="col-lg-7 rt-pt-md-30">
                    <div class="row">
                        <div class="col-md-4 col-sm-4   text-center rt-mb-20">
                            <div class="f-size-24 ft-wt-5 text-gray-10">
                                <!-- <span class="counter">{{ livejob() }}</span> -->
                                <span class="counter">{{ intval(livejob()) + 100 }}</span>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4   text-center rt-mb-20">
                            <div class="f-size-24 ft-wt-5 text-gray-10">
                                ...
                                <span class="counter">{{ intval(companies()) + 5000 }}</span>
                            </div>
                            <span class="text-gray-500 f-size-16">{{ __('companies') }}</span>
                        </div>
                        <div class="col-md-4 col-sm-4  text-center rt-mb-20">
                            <div class="f-size-24 ft-wt-5 text-gray-10">
                                <!-- <span class="counter">{{ candidate() }}</span> -->
                                <span class="counter">{{ intval(candidate()) + 10000 }}</span>
                            </div>
