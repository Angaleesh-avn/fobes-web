...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WPRMT2RD"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

<header class="header rt-fixed-top">
    <div class="n-header">
        <div class=" relative bg-set">    <!--n-header--top-->
            @auth('user')
                @if (!authUser()->status)
                                ...
                                <div class="container">
                                    <ul class="menu-active-classes">
                                        @if (isset($company_menu_lists))
                                            ...
                                            @endforeach
                                                <li class="menu-item">
                                                    <a href="{{ route('company.resdex_plans') }}"
                                                        class="{{ urlMatch(url()->current(), url($company_menu_list['url'])) ? 'text-primary active' : '' }}">
                                                        Resdex
                                                    </a>
                            ...
                            <div class="container">
                                @if ($cms_setting->footer_phone_no)
                                    <div class="contact-info">
                                        <a class="text-white" href="tel:{{ $cms_setting->footer_phone_no }}">
