<div class="rt-site-footer ">       <!--bg-gray-900 dark-footer-->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-6 rt-single-widget ">
                    <a href="#" class="footer-logo">
                        ...
                        <p>Fobes Skill Itech Private Limited</p>
                    </a>
                    <address>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 rt-single-widget new-hover">
    ...
    <div class="footer-bottom bg-set">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center text-lg-start f-size-14 text-white-500">
                ...
                <div class="col-lg-6 text-center text-lg-end">
                    <ul class="footer-social-links">
                        ...
                        @if ($cms_setting->footer_linkedIn_link)
                            <li>
                                <a href="{{ $cms_setting->footer_linkedIn_link }}">

                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="#0077B5">
                                        <path d="M20.125 0H3.875C1.737 0 0 1.737 0 3.875v16.25C0 22.263 1.737 24 3.875 24h16.25C22.263 24 24 22.263 24 20.125V3.875C24 1.737 22.263 0 20.125 0zM7.5 20.25H4.5V9h3v11.25zM6 7.875c-.69 0-1.25-.56-1.25-1.25S5.31 5.375 6 5.375 7.25 5.935 7.25 6.625 6.69 7.875 6 7.875zM21 20.25h-3v-4.5c0-1.125-.022-2.575-1.562-2.575-1.564 0-1.798 1.219-1.798 2.475v4.6h-3V9H14v1.312h.025c.362-.684 1.25-1.406 2.575-1.406 2.75 0 5.125 1.8 5.125 5.625v6.719z"/>
                                    </svg>
                                </a>
                            </li>
                        @endif
