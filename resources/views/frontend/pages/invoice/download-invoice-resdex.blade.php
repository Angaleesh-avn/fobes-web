        ...
        <div class="ll-invoice-in">
            <div class="ll-invoice-head">
                <div class="ll-invoice-logo">
                    <img src="data:image/svg+xml;base64,<?php echo base64_encode(file_get_contents(base_path('public/').setting()->dark_logo)); ?>" alt="">
                </div>
            ...
            <div class="ll-invoice-table-wrap">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                @if ($transaction->payment_type != 'per_job_based')
                                <td>
                                    <span>Credits : {{ $transaction->plan->credits }} CV views</span> <br>
                                    <br>
                                </td>
                                @endif
                                <td style="font-family: DejaVu Sans; sans-serif;">{{ $amount }}</td>
                                <td>1</td>
                                <td class="text-right" style="font-family: DejaVu Sans; sans-serif;" >{{ $amount }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="ll-invoice-footer-table">
                    <div class="left-side">
                        ...
                        <p style="font-family: DejaVu Sans; sans-serif;">Payment Type - {{ str_replace('_', ' ', ucfirst($transaction->payment_type)) }}
                        ...
                        <table>
                            <tbody>
                                <tr style="background: #f5f6fa;">
                                    ...
                                    <td class="text-right" style="color: #111; font-weight: 700;border-top: 1px solid #dbdfea; font-family: DejaVu Sans; sans-serif;">{{ $amount }}</td>
                                </tr>
                                <tr style="background-color: {{ $setting->main_color }}; color: white;">
                                    <td style="font-size: 16px; font-weight: 700;">Grand Total </td>
                                    <td style="font-size: 16px; font-weight: 700; font-family: DejaVu Sans; sans-serif;" class="text-right">
                                        {{ $amount }}
                                    </td>
                                </tr>
                            </tbody>
