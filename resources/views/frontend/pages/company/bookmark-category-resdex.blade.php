                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="text-end mr-2">
                                                                        <a href="{{ route('company.bookmark.category.edit_resdex', $cat->id) }}"
                                                                        ...
                                                                        <form class="d-none"
                                                                            ...
                                                                            action="{{ route('company.bookmark.category.destroy_resdex', $cat->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                        </form>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="post-job-item rt-mb-15">
                                            <form
                                                action="{{ request()->routeIs('company.bookmark.category.index_resdex')
                                                    ? route('company.bookmark.category.store_resdex')
                                                    : route('company.bookmark.category.update_resdex', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                @if (request()->routeIs('company.bookmark.category.index_resdex'))
                                                @else
                                                    @method('PUT')
                                                @endif
                                                <div class="rt-mb-20">
                                                    ...
                                                    <input name="name"
                                                        @if (request()->routeIs('company.bookmark.category.index_resdex')) @else value="{{ $category->name }}" @endif
                                                ...
                                                @else
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <a href="{{ route('company.bookmark.category.index_resdex') }}"
