                                        ...
                                        <div class="resume-lists">
                                            ...
                                            <div class="resume-item add-resume" data-bs-toggle="modal"
                                                ...
                                                <div>
                                                    ...
                                                    <h6 class="resume-size">{{ __('browse_file_here_only') }} - pdf or doc</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form action="{{ route('candidate.settingUpdate') }}" method="POST">
                                        ...
                                        <div class="dashboard-account-setting-item">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <x-forms.label :required="true" name="whatsapp_number"
                                                        class="pointer body-font-4 d-block text-gray-900 rt-mb-8" /> <span style="color:red;"><small>Whatsapp no. is required for the regular updates</small></span>
                        ...
                        <div class="form-group tw-mb-6">
                            ...
                            <div class="cv-image-upload-wrap">
                                <input name="resume_file" class="resume-file-upload-input" type="file"
                                    onchange="resumeManageReadURL(this, 'add');" accept="application/pdf,application/msword"
                                    id="resume_add_input" />
                                <div class="drag-text">
                                    <x-svg.upload-icon />
                                    <h3>{{ __('browse_file') }}</h3>
                                    <p>{{ __('available_format') }} - PDF or DOC<br>
                ...
                <form action="{{ route('candidate.resume.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group tw-mb-6">
                            ...
                            <div class="cv-image-upload-wrap">
                                <input name="resume_file" class="resume-file-upload-input" type="file"
                                    onchange="resumeManageReadURL(this, 'edit');" accept="application/pdf,application/msword"
