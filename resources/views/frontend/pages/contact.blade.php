        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 rt-mb-lg-30 ">
                    <div class="pl30">
                        <span class="body-font-3 ft-wt-5 text-primary-500 rt-mb-15 d-inline-block"><h2><b>Contact Us</b></h2></span>
                        ...
                        <p class="body-font-2 text-gray-500 rt-mb-32">
                            ...
                            For further queries, comments, or requests, please feel free to contact us at +91 9943300100. You can send an email to: admin@fobes.in
                            <br>
                            <b><h6>Registered Address:</h6></b>
                             <br>
                            Level 5, Tamarai Tech Park, S.P. Plot No. 16-19 & 20 A, Thiru Vi Ka Industrial Estate, Inner Ring Road, Guindy, Chennai, Tamil Nadu, 600 032, India.
                             <br>
                            <b><h6>Tel:</h6></b>
                            994-330-0100
                        </p>
