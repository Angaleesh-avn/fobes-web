            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.social.login.update') }}" method="POST"
                        ...
                        <input type="hidden" value="{{ config('templatecookie.google_active') }}" name="status">
                        <div class="form-group row">
                            <x-forms.label name="Google Client Id" class="col-sm-5" />
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.google_id') }}" name="google_client_id" type="text"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.google_secret') }}" name="google_client_secret"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input {{ config('templatecookie.google_active') ? 'checked' : '' }} type="checkbox"
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.social.login.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.facebook_id') }}" name="facebook_client_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.facebook_secret') }}" name="facebook_client_secret"
                                    type="text"
                        ...
                        <div class="form-group row">
                            <x-forms.label name="status" class="col-sm-5" />
                            <div class="col-sm-7">
                                <input {{ config('templatecookie.facebook_active') ? 'checked' : '' }} type="checkbox"
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.social.login.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.twitter_id') }}" name="twitter_client_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.twitter_secret') }}" name="twitter_client_secret"
                                    type="text"
                        ...
                        <div class="form-group row">
                            <x-forms.label name="status" class="col-sm-5" />
                            <div class="col-sm-7">
                                <input {{ config('templatecookie.twitter_active') ? 'checked' : '' }} type="checkbox"
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.social.login.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.linkedin_id') }}" name="linkedin_client_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.linkedin_secret') }}" name="linkedin_client_secret"
                                    type="text"
                        ...
                        <div class="form-group row">
                            <x-forms.label name="status" class="col-sm-5" />
                            <div class="col-sm-7">
                                <input {{ config('templatecookie.linkedin_active') ? 'checked' : '' }} type="checkbox"
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.social.login.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.github_id') }}" name="github_client_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('templatecookie.github_secret') }}" name="github_client_secret"
                                    type="text"
                        ...
                        <div class="form-group row">
                            <x-forms.label name="status" class="col-sm-5" />
                            <div class="col-sm-7">
                                <input {{ config('templatecookie.github_active') ? 'checked' : '' }} type="checkbox"
