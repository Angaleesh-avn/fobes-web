...
<head>
    ...
    <style>
        ...
        .background-view {
            /*background-image: url('https://source.unsplash.com/random/1920x1280/?park,travel,sunset'), */
            /*url('/backend/image/river.jpeg');*/
            background-image: url('{{ asset('/admin-login2.png') }}'),
            url('/backend/image/admin-login2.jpg');
