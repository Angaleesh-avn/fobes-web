            ...
            <nav class="sidebar-main-nav mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                    ...
                    @if (userCan('order.view'))
                        ...
                        <x-admin.sidebar-list :linkActive="request()->routeIs('order.index_resdex') ? true : false" route="order.index_resdex" icon="fas fa-money-bill"
                             path="order.index_resdex" plus_icon="" >
                            Order Resdex
                        </x-admin.sidebar-list>
                    @endif
                    <!-- ======= Company ======== -->
                    ...
                    @if (Module::collections()->has('Plan') && userCan('plan.view'))
                        ...
                        <x-admin.sidebar-list :linkActive="Route::is('module.plan_resdex.index') ||
                        Route::is('module.plan_resdex.create') ||
                        Route::is('module.plan_resdex.edit')
                            ? true
                            : false" route="module.plan_resdex.index"  path="module.plan_resdex.create" plus_icon="fa fa-plus-circle"  icon="fas fa-credit-card">
                            {{ __('price_plan') }} Resdex 
                        </x-admin.sidebar-list>
