            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title line-height-36">{{ __('order_create') }} Resdex</h3>
                        <a href="{{ route('order.index_resdex') }}"
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            <form class="form-horizontal" action="{{ route('order.store_resdex') }}" method="POST">
                                @csrf
