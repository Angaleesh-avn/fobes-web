                ...
                <div class="card">
                    <div class="card-body ">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <form action="{{ route('admin.transaction.invoice.download_resdex', $order->id) }}" method="POST"
                                ...
                                <form action="{{ route('admin.transaction.invoice.view_resdex', $order->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-12 mt-5">
                                    ...
                                    <h6 class="mb-2">Credits:
                                        <strong>{{ $order->plan->credits }} CV views</strong>
                                    </h6>
                                </div>
                            </div>
                        </div>
